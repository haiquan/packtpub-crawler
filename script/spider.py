...
from logs import *
from notify import Notify, SERVICE_EMAIL, SERVICE_GMAIL, SERVICE_IFTTT, SERVICE_JOIN, SERVICE_PUSHOVER
...
def main():
    ...
    parser.add_argument('-n', '--notify', choices=[SERVICE_EMAIL, SERVICE_GMAIL, SERVICE_IFTTT, SERVICE_JOIN, SERVICE_PUSHOVER], help='notify after claim/download')
